...
export function metricsAttendance() {
 ...
 Object.assign(node('Read Comm Event').parameters,{returnAll:false,limit:1,orderBy:true,orderByColumn:'revision',orderByDirection:'DESC'});
 g.connections['Read Config']={main:[[{node:'Read Pending ES',type:'main',index:0}]]};
 g.chain('Read Pending ES','Include Metrics');g.link('Include Metrics','Read Norm Bundles');g.link('Include Metrics','Decide',1);g.chain('Read Norm Bundles','Read Prior View','Read Comm Unread','Read Comm Any','Read Comm Event','Decide');
