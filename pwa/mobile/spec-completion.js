(() => {
  ...
  const css=document.createElement('link'); css.rel='stylesheet'; css.href=`./spec-completion.css?v=${window.MOL_BUILD||'20260911.6'}`; document.head.append(css);
