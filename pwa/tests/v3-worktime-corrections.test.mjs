...
assert.match(app, /20260917\.6-v3-cutover/, 'web runtime build must include current V3 backend cutover release');
assert.match(sw, /20260915\.7-mobile-loading-fix/, 'service worker cache must retain V3 release lineage');
assert.match(sw, /20260917\.6-v3-cutover/, 'service worker cache must include current V3 backend cutover release');
